...
export default function App() {
  ...
  return (
    <div style={S.root}>
      ...
      <div style={S.wrap}>
        {screen === "dashboard"  && <Dashboard nestEgg={nestEgg} houseNetRent={houseNetRent} houseNetBuy={houseNetBuy} house={house} setHouse={setHouse} monthlyDraw={monthlyDraw} runway={runway} />}
...
function Dashboard({ nestEgg, houseNetRent, houseNetBuy, house, setHouse, monthlyDraw, runway }) {
